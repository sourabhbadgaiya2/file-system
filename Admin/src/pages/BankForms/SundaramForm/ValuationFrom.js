    ...
    <div className="container py-4">
      ...
      <Form onSubmit={handleSubmit}>
        <Row>
          ...
          {renderSelect(
            "Usage of Property - Master Plan",
            "usage_master_plan",
            ["Residential", "Commercial", "Industrial"],
          )}
          {renderSelect("Usage of Property - Site", "usage_site", [
            "Residential",
            "Commercial",
            "Industrial",
          ])}
          {renderSelect("Marketability of the Property", "marketability", [
            "EXCELLENT",
            "GOOD",
            "AVERAGE",
            "BELOW AVERAGE",
        ...
        <Row>
          ...
          {renderSelect("Construction Type", "construction_type", [
            "New Construction",
            "Old Construction",
          ])}
          {renderSelect("Structure", "structure", [
            "Framed",
            "Load Bearing",
            "Mixed",
            "Steel",
          ])}
          {renderSelect("Roof", "roof", [
            "Industry roof",
            "Light",
            "Madras Terrace",
            "RCC",
        ...
        <Row>
          {renderCheckboxGroup("Flooring", "flooring", [
            "Cement",
            "Ceramic Tiles",
            "Granite",
            "Marble",
        ...
        <Row>{renderInput("Details of Rooms", "details_of_rooms")}</Row>
        <Row>
          {renderSelect("Stage of Construction", "stage_of_construction", [
            "Under Construction",
            "Completed",
          ])}
        ...
        <Row>
          {renderCheckboxGroup("Natural Protection", "natural_protection", [
        ...
        <Row>
          {renderCheckboxGroup("Facilities Available", "facilities", [
            "CCTV",
            "Club House",
            "Community Hall",
            "Covered Car Park",
        ...
        <Row>
          ...
          {renderSelect("Property Outlook", "property_outlook", [
            "POSITIVE",
            "NEGATIVE",
            "NEUTRAL",
          ])}
