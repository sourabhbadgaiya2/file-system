    ...
    <div className="container py-4">
      <Form onSubmit={handleSubmit}>
        <Form.Group className="mb-3">
          ...
          <Form.Select value={formData.developmentLocality} onChange={e => handleChange('developmentLocality', e.target.value)}>
        ...
        <Form.Group className="mb-3">
          ...
          <div className="d-flex flex-wrap gap-2">
            {['Agricultural', 'Commercial', 'Dry Vacant Land', 'Industrial', 'Institutional', 'Logistic', 'Residential', 'Residential Cum Commercial', 'Warehouse'].map((item) => (
              <Form.Check
                inline
                key={item}
                label={item}
        ...
        <Form.Group className="mb-3">
          ...
          <Form.Select value={formData.classification} onChange={e => handleChange('classification', e.target.value)}>
            <option value="">Select</option>
        ...
        <Form.Group className="mb-3">
          ...
          <div className="d-flex flex-wrap gap-2">
            {['Electrical Line', 'Gated Communities', 'Road', 'Street Light', 'Telephone Line'].map((item) => (
              <Form.Check
                inline
                key={item}
                label={item}
        ...
        <Form.Group className="mb-3">
          ...
          <div className="d-flex flex-wrap gap-2">
            {['Bore Well', 'Local Body Water Connection', 'Open Well', 'Over Head Tank', 'Under Ground Sump'].map((item) => (
              <Form.Check
                inline
                key={item}
                label={item}
        ...
        <Form.Group className="mb-3">
          ...
          <div className="d-flex flex-wrap gap-2">
            {['Septic Tank', 'Sewage Treatment Plant', 'Under Ground Sewage System'].map((item) => (
              <Form.Check
                inline
                key={item}
                label={item}
