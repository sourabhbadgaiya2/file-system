                ...
                <Row className="justify-content-center">
                    <Col md={8} lg={6} xl={5}>
                        <Card className="overflow-hidden">
                            <CardBody className="pt-0">
                                <h3 className="text-center mt-5 mb-4">
                                    ...
                                    <h1>Unique <br /> Engineering</h1>
                                    </Link>
                                </h3>
                                <div className="p-3">
                                    <h4 className="text-muted font-size-18 mb-1 text-center">Free Register</h4>
                                    <p className="text-muted text-center">Get your free Unique account now.</p>
                                    <Form
                        ...
                        <div className="mt-5 text-center">
                          ...
                          © 2025   <script>document.write(new Date().getFullYear())</script>  <span className="d-none d-sm-inline-block"> - Crafted with <i className="mdi mdi-heart text-danger"></i> by codepact</span>
                        </div>
                    </Col>
                </Row>
            </Container>
