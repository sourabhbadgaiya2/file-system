  ...
  return (
    <Container className="py-4">
      ...
      <div className="border p-3 bg-light" style={{ whiteSpace: 'pre-line' }}>
        ...
        <div className="mt-2">
          1. GIVEN XEROX COPY OF SALE DEED IT IS FAVOUR OF MR. ROOPAM SEWANI S/O. MR. MOTILAL SEWANI.
          2. DURING PROPERTY VISIT MR. GAGAN KUMAR J MET AT THE PROPERTY WHO IS CUSTOMER WIFE CONTACT NO. 7566888270. IT WAS CLEARLY EXPLAINED TO HIM THAT THE PROPERTY VISIT IS BEING DONE FOR VALUATION PURPOSE IN RELATION WITH LOAN PROPOSAL.
          ...
          5. AT SITE PROPERTY IS G+3 UNDER CONST. RESIDENTIAL HOUSE WHICH IS WORK DONE UP TO SLAB, BRICK & INTERIOR PLASTER WORK COMPLETE AND FLOORING ELECTRIFICATION AND OUTSIDE PLASTER WORK IS W.I.P.
