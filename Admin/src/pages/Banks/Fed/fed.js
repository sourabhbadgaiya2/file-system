...
import { saveAs } from 'file-saver';
 ...
 export const Fed = () => {
  const handleExportPDF = () => {
    ...
    html2canvas(input, { scale: 2, useCORS: true }).then(canvas => {
      ...
      if (imgHeight > pageHeight - margin * 2) {
        // Image is taller than one page, need to split it into multiple pages
        let position = margin;
  ...
  return (
    ...
    <div id="radio" claasName="technical-report">
      <table id="reportTable" cellSpacing="0" cellPadding="0" style={{ width:"100%" }} >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="107">BHOPAL</td>
            <td width="101">Date of Report</td>
            <td colSpan="2" width="186">12.02.2025</td>
          </tr>
          <tr>
            <td>1</td>
          ...
          <tr>
            ...
            <td colSpan="2" width="396">L0000018458</td>
            <td width="95">1.7</td>
            <td colSpan="2" width="208">Reference Number</td>
            <td className='fw-bold' colSpan="2" width="186">NA</td>
          </tr>
          <tr>
            <td>1.2</td>
            ...
            <td width="95">1.8</td>
            <td colSpan="2" width="208">Current Property owner name as per ownership document ( also mention document name)</td>
            <td colSpan="2" width="186">MO AAMIR S/O MR. MO. IMAM KHAN</td>
          </tr>
          <tr>
            <td>1.3</td>
            <td width="244">Co-applicant Details</td>
            <td colSpan="2" width="396">MRS, IRAM MIRZA</td>
            <td width="95">1.9</td>
          ...
          <tr>
            ...
            <td colSpan="2" width="396">12.02.2025</td>
            <td width="95">1.10'</td>
            <td colSpan="2" width="208">Visit Done By</td>
            <td colSpan="2" width="186">MR. BHAGWAT</td>
          </tr>
          <tr>
            <td>1.5</td>
            <td width="244">Case Type</td>
            <td colSpan="2">STL- NEW FIXED</td>
            <td width="95">1.11</td>
            <td colSpan="2">Person met at site</td>
            <td colSpan="2">MR, MO AAMIR</td>
          </tr>
          <tr>
            <td>1.6</td>
            <td width="244">Contact Number of person met at site</td>
            <td colSpan="2" width="396">( 9713742877 ), 8224038590</td>
            <td width="95">1.12</td>
          ...
          <tr>
            ...
            <td colSpan="2" width="396">PROPERTY AT PLOT NO. 67, PART OF KH. NO. 61/2, 63, 64,65,67,68,69, KUTEER NAGAR NEAR BY LODHI NAGAR, WARD NO.73 GRAM BHANPUR TEHSIL HUZUR, DIST BHOPAL</td>
            <td width="95">2.4</td>
          ...
          <tr>
            ...
            <td colSpan="2" width="396">462037</td>
            <td width="95">2.5</td>
            <td colSpan="2" width="208">Nearby landmark</td>
            <td colSpan="2" width="186">NEAR BY MASJID BILAL</td>
          </tr>
          <tr>
            <td>2.3</td>
            <td width="244">Latitude &amp; Longitude</td>
            <td colSpan="2" width="396">23.294481 77.425164</td>
            <td width="95">2.6</td>
            <td colSpan="2" width="208">Seismic Zone</td>
            <td colSpan="2" width="186">lll</td>
          </tr>
          <tr>
            <td>3</td>
          ...
          <tr>
            ...
            <td width="251">YES</td>
            <td colSpan="2" width="240">Approving Authority</td>
            <td colSpan="2" width="208">NAGAR NIGAM BHOPAL</td>
            <td width="101">Approval Number &amp; Date</td>
            <td width="85">0465/1767/2022</td>
          </tr>
          <tr>
            <td>3.3</td>
          ...
          <tr>
            ...
            <td width="145">PLOT NO. 68</td>
            <td colSpan="2" width="202">PLOT NO. 66</td>
            <td width="101">ROAD</td>
            <td colSpan="2" width="186">PLOT NO. 82</td>
          </tr>
          <tr>
            <td>4.3</td>
            <td width="251">As per Plan</td>
            <td width="145">NA</td>
            <td colSpan="2" width="202">NA</td>
            <td width="101">NA</td>
            <td colSpan="2" width="186">NA</td>
          </tr>
          <tr>
            ...
            <td width="145">PLOT NO. 68</td>
            <td colSpan="2" width="202">HOUSE NO. 66</td>
            <td width="101">ROAD</td>
            <td colSpan="2" width="186">HOUSE NO. 82</td>
          </tr>
          <tr>
            <td width="68">4.5</td>
            <td width="244">Boundaries Matching</td>
            <td colSpan="2" width="396">YES</td>
          ...
          <tr>
            ...
            <td colSpan="2" width="396">VACANT</td>
          ...
          <tr>
            ...
            <td colSpan="6" width="634">600</td>
          </tr>
          <tr>
            <td width="68">7.2</td>
            <td width="251">Land Rate(Per sq. ft.)</td>
            <td width="145">1500</td>
            <td width="95">7.11</td>
            <td colSpan="2" width="208">Land Value</td>
            <td colSpan="2" width="186">900000.00</td>
          </tr>
          <tr>
            <td width="68">7.3</td>
            ...
            <td colSpan="2" width="186">0.63</td>
          </tr>
          <tr>
            <td width="68">7.4</td>
          ...
          <tr>
            ...
            <td width="251">G.F</td>
            <td width="145">375</td>
            <td colSpan="2" width="202">1200</td>
          ...
          <tr>
            ...
            <td width="251">&nbsp;</td>
            <td colSpan="3" width="347">&nbsp;</td>
            <td colSpan="3" width="287">1350000.00</td>
          </tr>
          <tr>
