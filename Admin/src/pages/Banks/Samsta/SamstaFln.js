  ...
  return (
    ...
    <table id="reportTable" cellSpacing="0" cellPadding="0" style={{ width: "100%", height: "100%" }}>
        ...
        <tbody>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">BASIC DETAILS</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">SOUROUNDING &amp; LOCALITY DETAILS</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">PROPERTY DETAILS</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">SANCTION PLAN APPROVAL &amp; OTHER DOCUMENTS DETAILS</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">Floor Wise Area (In Sft.)</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">VALUATION</td>
          </tr>
          <tr>
            <td className='fw-bold' colSpan="8" width="818">(A)Description of Constructed Area and Rates</td>
          </tr>
          <tr>
            <td className='fw-bold' width="203">For Row House /Plots/ Villa and </td>
            <td className='fw-bold' colSpan="2" width="157">Description</td>
            <td className='fw-bold' colSpan="2" width="180">Area (Sft.)</td>
            <td className='fw-bold' >Rate (Sft.)</td>
            <td className='fw-bold' colSpan="2">Amount</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' colSpan="8" width="818">(B)Value of Extra Amenities if applicable</td>
          </tr>
          <tr>
          ...
          <tr>
            <td className='fw-bold' width="203">Boundaries</td>
            <td className='fw-bold' colSpan="2" width="157">EAST</td>
            <td className='fw-bold' colSpan="2" width="180">WEST</td>
            <td className='fw-bold' >NORTH</td>
            <td className='fw-bold' colSpan="2">SOUTH</td>
          </tr>
          <tr>
            <td className='fw-bold' width="203">As per deed</td>
          ...
          <tr>
            <td className='fw-bold' width="203">At site</td>
            <td colSpan="2" width="157">HOUSE OF RAMESH JI</td>
            <td colSpan="2" width="180">HOUSE OF DILIP JI</td>
          ...
          <tr>
            <td className='fw-bold' width="203">Boundaries Matching</td>
          ...
          <tr>
            <td colSpan="8" width="818">:  We hereby declare that we have no direct or indirect interest in the valued and the information furnished in the report is true and correct to the best of my knowledge of belief.</td>
          </tr>
          <tr>
