...
// invoice
import BharatInvoice from './BharatInvoice';
import AdtiyaInvoice from './AdtiyaInvoices';
import BajajJan from './BajajJan';
import FedInvoice  from "./FedInvoice"
import ManipuramInvoices from './ManipuramInvoices';
import FincropInvoices from './FincropInvoices';
import SundaramInvoice from './SundaramInvoice';
import UtkrashInvoices from './UtkrashInvoices';
import PiramalNpaInvoices from './PiramalNpaInvoices';
import ShubhamInvoices from './ShubhamInvoices';
import ProfectusInvoice from './ProfectusInvoice';
import IciInvoices from './IciInvoices';
import HomefristInvoices from './HomefristInvoices';
import AgriwiseInvoice from './AgriwiseInvoice';
import IciciHfcInvoice from './IciciHfcInvoice';


const banks = [
  { id: 0, name: 'BharatInvoice', logo: Adityalogo, component: BharatInvoice },
  { id: 1, name: 'AdtiyabiralInvocies', logo: Adityalogo , component: AdtiyaInvoice },
  { id: 2, name: 'Bajajinvocies', logo: bajalog, component: BajajJan },
  { id: 3, name: 'Fedinvocies', logo: fed, component: FedInvoice },
  { id: 4, name: 'FincropInvoices', logo: velocity, component:  FincropInvoices},
  { id: 5, name: 'IciInvoices', logo: icilogo, component: IciInvoices },



//   { id: 4, name: 'PiramalNpa Bank', logo: PiramalLogo, component: PiramalNpa },
//   { id: 5, name: 'IDFC BANK', logo: idfc, component: IdfcBank },
  { id: 6, name: 'Manipuram Invoices', logo: manupuram, component: ManipuramInvoices },
  { id: 7, name: 'SamstaFln', logo: samstafln, component: SamstaFln },
  { id: 8, name: 'ProfectusInvoice', logo: Profectuslogo, component: ProfectusInvoice  },
  { id: 9, name: 'Protiums Bank', logo: Protiums, component: Protiumsbanks },
  { id: 10, name: 'Agriwise Invoice', logo: Agriwiselogo, component: AgriwiseInvoice },
  { id: 11, name: 'Bajajameriya Bank', logo: bajalog, component: Bajajameriya },
  { id: 12, name: 'Bajaj Bank', logo: bajalog, component: Bajaj },
  { id: 13, name: 'DmiFinanace Bank', logo: DmiFinanacelogo, component: DmiFinanace },
  { id: 14, name: 'Homefrist Invoices', logo: Homefirstlogo, component: HomefristInvoices },
  { id: 15, name: 'ShriRam Bank', logo: ShriRamlogo, component: ShriRam },
  { id: 16, name: 'ShubhamInvoices', logo: Shubhamlogo, component: ShubhamInvoices },
  { id: 17, name: 'SundaramInvoice', logo: Sundaramlogo, component: SundaramInvoice },
  { id: 18, name: 'Suryodaya Bank', logo: Suryodayalogo, component: Suryodaya },
  { id: 19, name: 'Utkrash Invoices', logo: Utkarshlogo, component: UtkrashInvoices },
  ...
  { id: 24, name: 'Homefirst Trench', logo: Homefirstlogo, component: HomeTrench },
  { id: 25, name: 'IciciHfc Invoice', logo: icilogo, component:  IciciHfcInvoice  },
  { id: 26, name: 'PiramalNpa Invoices', logo:  PiramalLogo, component: PiramalNpaInvoices  },
      ...
      {selectedBank ? (
        <div>
          ...
          <div className="d-flex justify-content-center">
            <img src={selectedBank.logo} alt="" className="mb-2" style={{ width: '120px' }} />
          </div>
